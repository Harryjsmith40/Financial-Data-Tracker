...
class DataRepository(FinancialBase):
    ...
    def read_master(self):
        ...
        master_record = pd.read_csv(master_record_path, dtype=self.schema['dtypes'], parse_dates=self.schema['date_columns'], date_format=schema['date_format'])
    ...
    def create_master(self, master_record):
    ...
    def update_timestamp(self, selection, account_info):
